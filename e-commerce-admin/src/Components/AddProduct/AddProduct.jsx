...
const AddProduct = () => {
  ...
  const AddProduct = async () => {
    ...
    await fetch('https://indian-cart-e-com-website.onrender.com/upload', {
      method: 'POST',
      headers: {
    ...
    if (dataObj.success) {
      ...
      console.log(product);
      await fetch('https://indian-cart-e-com-website.onrender.com/addproduct', {
      method: 'POST',
      headers: {
        Accept:'application/json',
  ...
  return (
    <div className="addproduct">
      <div className="addproduct-itemfield">
        <p className="pt">Product title</p>
      ...
      <button className="button" onClick={()=>{AddProduct()}}>
        <span className="button-content">Add Product</span></button>
    </div>
  );
};
